        ...
        <main>
                ...
                <div class="section-content-wrapper com-border com-shadow com-round">
                    ...
                    <div class="section-content-horizontal-wrapper">
                        ...
                        <div class="map-small-container">
                            <div id="map-small" class="map-small" style="width: 100%; height: 100%;"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="reviews">
                <div class="section-content-wrapper com-border com-shadow com-round">
                    ...
                    <div class="card-list-wrapper">
                        <button class="scroll-left scroll-btn com-btn-circle com-btn-secondary com-border com-list-hover-animate" disabled>
                            <i class="fa fa-chevron-left"></i>
                        </button>
                        <ul class="card-list"></ul>
                        <button class="scroll-right scroll-btn com-btn-circle com-btn-secondary com-border com-list-hover-animate">
            ...
            <section id="category">
                <div class="section-content-wrapper  com-border com-shadow com-round">
                    ...
                    <div class="category-tab-header"></div>
                    <div class="category-tab-content-wrapper">
                        <div class="category-tab-contents com-border-bottom"></div>
                        <button id="prev-btn" class="scroll-btn com-btn-circle com-btn-secondary scroll-left com-border com-list-hover-animate" disabled>
                            <i class="fa fa-chevron-left"></i>
                        </button>
                        <button id="next-btn" class="scroll-btn com-btn-circle com-btn-secondary scroll-right com-border com-list-hover-animate">
                            <i class="fa fa-chevron-right"></i>
                        </button>
                    </div>
